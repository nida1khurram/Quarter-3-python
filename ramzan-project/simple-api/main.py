from fastapi import FastAPI # call fastapi
import random #

app = FastAPI() #app variable pass fastapi
#list of side hustle
side_hustles = [
...
#create decorater @app end point-> get /post
@app.get("/side_hustles")#route handler ->("/side_hustles")
#func
